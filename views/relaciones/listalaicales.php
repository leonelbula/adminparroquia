	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li class="active">Asociaciones Laicales</li>
			</ul>
								...
								<div class="widget-main no-padding">
									<table class="table table-striped table-bordered table-hover">
										...
										<tbody>
											...
											<tr>
												<td class="">
													<a href="<?=URL_BASE?>relaciones/detallesdist&id=<?=$row2->id_relaciones_distinta?>"><?=$row2->nombreInstituto?></a>
												</td>
												...
												<div class="hidden-sm hidden-xs action-buttons">
													<a class="blue" href="<?=URL_BASE?>relaciones/detallesdist&id=<?=$row2->id_relaciones_distinta?>">
												...
												<div class="hidden-md hidden-lg">
													<div class="inline pos-rel">
														...
														<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
															<li>
																<a href="<?=URL_BASE?>relaciones/detalles&id=<?=$row2->id_relaciones_distinta?>" class="tooltip-info" data-rel="tooltip" title="Ver">
																	<span class="blue">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="<?=URL_BASE?>relaciones/guardardistinta" enctype="multipart/form-data" method="POST">
