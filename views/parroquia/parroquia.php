					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							<li>
								...
								<a href="<?= URL_BASE ?>">Principal</a>
							</li>

							<li>
								<a href="<?= URL_BASE ?>parroquia/">Parroquias</a>
							</li>
							<li class="active">Datos Parroquiales</li>
						</ul><!-- /.breadcrumb -->
										...
										<div class="col-xs-12 col-sm-3 center">
											<div>
												<span class="profile-picture">
													<img id="avatar" class="editable img-responsive" alt="Alex's Avatar" src="<?= URL_BASE ?>assets/images/avatars/profile-pic.jpg" />
												</span>
										...
										<div class="col-xs-12 col-sm-9">
											...
											<div class="profile-user-info profile-user-info-striped">
                                                ...
                                                <div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="about"><a href="#">sacerdote </a></span>
													</div>
												</div>
											</div>
